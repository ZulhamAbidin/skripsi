    ...
    <div class="bungkus">
        <div class="main mt-3 lg:fixed">
            ...
            <div class="header p-2 grid grid-cols-9 items-center ">
                ...
                <form action action=" {{ url('dashboard.data') }}" method="GET" class="col-span-9 row-start-1 lg:col-span-8 col-start-1 lg:col-start-2 flex items-center">
            ...
            <div class="header-button flex justify-end lg:justify-end mx-3 gap-1">
                ...
                <a href="/dashboard/data/create" type="button"
                    class="add-modal  text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2 text-center">
                ...
                <a href="/dashboard/cetak/cetak-data-pekerja-form" type="button"
                    class=" block text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="w-5 h-5 mr-1">
            ...
            <div class="bg-white lg: lg:mt-3 inset-0 z-10 p-4 lg:pb-0 lg:pt-0">
