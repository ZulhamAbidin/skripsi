    ...
    <div class="bungkus">
        ...
        <div class="main">
            <div class="topbar hidden md:flex">
             ...
             <div class="bg-white lg:absolute lg:mt-20 mt-15 inset-0 z-10 p-4">


            <div class="modal w-full top-24 md:top-24 lg:top-20 lg:right-0 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full" id="add-product-modal">
                            ...
                            <form method="POST" action="{{ url('dashboard/data/'.$model->id) }}">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="nama_lengkap" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select name="alamat_domisili"
                                            class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" value="{{ $model->alamat_domisili }}">
                                            <option value="{{ $model->alamat_domisili }}">{{ $model->alamat_domisili }}</option>
                                            <option value="-"></option>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="pendidikan_terakhir" class="text-sm font-medium text-gray-900 block mb-2">Pendidikan Terakhir</label>
                                          <select name="pendidikan_terakhir" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                            <option  value="{{ $model->pendidikan_terakhir }}">{{ $model->pendidikan_terakhir }}</option>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="jurusan" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Jurusan"
                                        value="{{ $model->jurusan }}">
